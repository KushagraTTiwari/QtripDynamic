...
function addAdventureDetailsToDOM(adventure) {
  ...
  let n  = document.getElementById("adventure-name")
  n.textContent=adventure.name

  let subt = document.getElementById("adventure-subtitle")
  subt.textContent = adventure.subtitle
  ...
  let ct = document.getElementById("adventure-content")
  ct.textContent = adventure.content
...
function calculateReservationCostAndUpdateDOM(adventure, persons) {
  ...
  let totalc = parseInt(adventure.costPerHead) * parseInt(persons)
  document.getElementById("reservation-cost").textContent = totalc
...
function showBannerIfAlreadyReserved(adventure) {
  ...
  const bnr = document.getElementById("reserved-banner")
